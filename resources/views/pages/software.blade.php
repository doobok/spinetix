      ...
      <span class="relative inline-block">
        ...
        <div class="max-w-xl mt-5 md:mx-auto sm:text-center lg:max-w-2xl md:mt-6">
            ...
            <p class="text-base text-gray-700 md:text-lg">
                Интерфейс русифицирован. Все действия — Drag&Drop. <br>
                В едином интерфейсе — все что нужно для работы: слои, устройства, виджеты, просмотрщик.
            </p>
        </div>
    </div>
...
{{--    small grid--}}
    <div class="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3 mb-24">
        <div class="text-gray-800 grid justify-items-center">
            ...
            <div class="flex flex-col justify-center">
                <p class="text-base text-gray-800">прямая публикация на плееры и группы</p>
            </div>
        </div>
        <div class="text-gray-800 grid justify-items-center">
            ...
            <div class="flex flex-col justify-center">
                <p class="text-base text-gray-800 text-center">единый интерфейс для работы с любыми средствами отображения, от отдельных экранов до интерактивных видеостен</p>
            </div>
        </div>
        <div class="text-gray-800 grid justify-items-center">
            ...
            <div class="flex flex-col justify-center">
                <p class="text-base text-gray-800">минималистичный интерфейс</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row">
            <div class="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                <h2 class="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                    <span class="inline-block text-blue-400">250 виджетов-конструкторов</span>
                    для создания <br class="hidden md:block" />
                    результативного контента
                </h2>
            </div>
            <div class="lg:w-1/2">
                <p class="text-gray-800 font-bold text-xl mb-4">Elementi</p>
                <p class="text-base text-gray-700 mb-4">
                    250 виджетов для любых целей: от даты и погоды до построения графиков
                </p>
                <p class="text-base text-gray-700 mb-4">
                    Виджеты позволяют создавать профессиональный контент, не используя видеопроизводство. С помощью виджетов вы можете автоматизировать контент и использовать данные из привычных инструментов: Excel, Google Sheets, социальных сетей, веб сайтов и баз данных.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="px-4 py-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-4">
        <div class="flex flex-wrap gap-3 row-gap-4 mx-auto sm:row-gap-5 lg:max-w-screen-lg">
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">диаграмма</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">google doc</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">интерактив</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">клипарт</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">часы</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">дата</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">счетчик</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">фон</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">screen control</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">календарь</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">facebook</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">twitter</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">время суток</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">текстовые эффекты</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">диаграммы</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">QR код</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">gauges</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">таблицы</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">RSS</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">текст</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">медиа</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">финансы</p>
                </div>
            </div>
            <div class="text-gray-800 grid justify-items-center rounded bg-gray-50 hover:bg-gray-200 p-3 w-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10 mb-1">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-base text-gray-800 capitalize text-center">погода</p>
                </div>
            </div>
            ...
            <div class="text-gray-800 grid justify-items-center rounded p-3">
                 <div class="flex flex-col justify-center">
                    ...
                    <p class="text-xl text-gray-800 text-center">виджетов в Elementi</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h3 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                Сравнительные характеристики версий Elementi
            </h3>
        </div>
                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 text-gray-800">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">10 экранов в локальной сети</td>
                                <td class="px-6 py-4">Любое кол-во экранов в любом месте</td>
                                <td class="px-6 py-4">Любое кол-во экранов в любом месте</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4">
                                    Количество плееров в списке устройств для публикации
                                </td>
                                <td class="px-6 py-4">До 10</td>
                                <td class="px-6 py-4">Любое</td>
                                <td class="px-6 py-4">Любое</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4">
                                    Публикация через внешние серверы
                                </td>
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    Разный уровень прав пользователей
                                </td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                                <td class="px-6 py-4 text-green-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.25 17.292l-4.5-4.364 1.857-1.858 2.643 2.506 5.643-5.784 1.857 1.857-7.5 7.643z"/></svg></td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    Создание уровней прав пользователей
                                </td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                                <td class="px-6 py-4 text-green-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.25 17.292l-4.5-4.364 1.857-1.858 2.643 2.506 5.643-5.784 1.857 1.857-7.5 7.643z"/></svg></td>
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    Расширенная настройка виджетов
                                </td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                                <td class="px-6 py-4 text-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7 14h-14v-4h14v4z"/></svg></td>
                                <td class="px-6 py-4 text-green-300"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.25 17.292l-4.5-4.364 1.857-1.858 2.643 2.506 5.643-5.784 1.857 1.857-7.5 7.643z"/></svg></td>
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="flex flex-col lg:flex-row">
            <div class="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                <h2 class="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                    C <span class="inline-block text-blue-400">Elementi</span>
                    от <span class="inline-block text-blue-400">SpinetiX</span><br>
                    работать очень просто
                </h2>
            </div>
            <div class="lg:w-1/2">
                <p class="text-gray-800 font-bold text-3xl mb-4">Вы сразу видите результат</p>
                <p class="text-base text-gray-700">
                    В программу встроен просмотрщик. Это уникальный движок, в котором вы делаете контент, и одновременно видите как это будет выглядеть на экране. Работают все элементы, видео, анимация, получение данных. Для окончательной проверки есть полноэкранный режим просмотра.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row mt-12">
            <div class="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                <div class="w-full flex justify-center">
                    <img class="h-48" src="/assets/click.svg" alt="" />
                </div>
            </div>
            <div class="lg:w-1/2">
                <p class="text-gray-800 font-bold text-3xl mb-4">Отправляйте контент на плееры в один клик</p>
                <p class="text-base text-gray-700">
                    Устройства группируются в любой иерархии. Проверяйте контент в просмотрщике, нажимайте «Опубликовать», и контент уже работает на экранах. Программа больше не нужна: ее можно закрыть до следующего изменения контента.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row mt-12">
            <div class="lg:w-1/2">
                <p class="text-gray-800 font-bold text-3xl mb-4">Используйте привычные инструменты и интерфейсы</p>
                <p class="text-base text-gray-700">
                    Elementi не требуется сервер и дорогостоящее оборудование. Программу устанавливают на обычные ноутбуки. Пользователям Mac OS дарим Parallels.
                </p>
            </div>
            <div class="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                <div class="w-full flex justify-center">
                    <img class="h-48" src="/assets/girl-laptop.svg" alt="" />
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row mt-12">
            <div class="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                <div class="w-full flex justify-center">
                    <img class="h-48" src="/assets/coworking.svg" alt="" />
                </div>
            </div>
            <div class="lg:w-1/2">
                <p class="text-gray-800 font-bold text-3xl mb-4">Работайте в привычных программах, данные автоматически попадут в Elementi</p>
                <p class="text-base text-gray-700">
                    Один раз настройте в Elementi получение данных плеерами из облачных хранилищ, соц. сетей, текстовых и табличных файлов, и обновляйте данные там. В следующий миг обновленная информация окажется на digital signage экранах без лишнего труда.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-gray-100">
            <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    ...
                    <p class="text-base text-gray-700 md:text-lg">
                        Скачайте 30-дневную демоверсию Elementi или руководство пользователя, для самостоятельного ознакомления с функциями редактора
                    </p>
                </div>
